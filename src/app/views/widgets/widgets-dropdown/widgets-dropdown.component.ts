...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  ngOnInit(): void {
    ...
    this.getRevenueBooks();
    this.getRevenueCustomers();
  }
  ...
  public getRevenueBooks() {
    this.RevenueService.getRevenueBooks().subscribe(response => {
      this.revenueBooks = response;
    })
  }

  public getRevenueCustomers() {
    this.RevenueService.getRevenueCustomers().subscribe(response => {
      this.revenueCustomers = response;
    })
  }
